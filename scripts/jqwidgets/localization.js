    ...
    switch (culture) {
        ...
        default:
            localization =
            {
                ...
                months: {
                    // full month names (13 months for lunar calendards -- 13th month should be "" if not lunar)
                    names: ["January", "February", "Março", "April", "May", "June", "July", "August", "September", "October", "November", "December", ""],
                    // abbreviated month names
                    namesAbbr: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec", ""]
                },
                // AM and PM designators in one of these forms:
                ...
                groupsheaderstring: "Arraste uma coluna aqui para agrupar",
                ...
                groupremovestring: "Remover agrupamento",
