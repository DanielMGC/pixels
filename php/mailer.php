...
class Mailer{
  ...
  public function SendMail($subject, $message, $to)
  {
      ...
      $mail->Host = 'smtp.thebob.com.br';
      $mail->Port = '587';
      $mail->Username = 'admin@thebob.com.br';
      $mail->Password = '2907TheBob';
      $mail->From = 'admin@thebob.com.br';
      $mail->FromName  = 'Pixel Creatures';
      $mail->IsHTML(true);
  ...
  {
    return $this->GetTemplate("The password is:", "[PASSWORD]", "for the user [USERNAME]", "Click here to login", "https://thebob.com.br/pixels");
  }

  public function GetTemplateApproved() {
    return $this->GetTemplate("The creature you created, called", "[NAME]", "was approved!", "Click here to see!", "https://thebob.com.br/pixels/view.php?c=[CODE]");
  }

  public function GetTemplateRejected($reason = -1) {
    $reasonText = "";
    if($reason == -2) {
      $reasonText = " due to low quality";
    } else if($reason == -3) {
      $reasonText = " due to being a duplicate or near duplicate of an existing creature";
    } else if($reason == -4) {
      $reasonText = " due to inappropriate content";
    }
    return $this->GetTemplate("The creature you created, called", "[NAME]", "was rejected" . $reasonText .". You can always edit it and save it again for a new approval request.", "Click here to edit", "https://thebob.com.br/pixels/index.php?c=[ID]");
  }

  public function GetTemplateCreated() {
    return $this->GetTemplate("A new creature was created:", "[NAME]", "", "Click here to see!", "https://thebob.com.br/pixels/index.php?c=[ID]");
  }

  public function GetTemplate($line1, $line2, $line3, $buttonText, $buttonLink)
  {
      ...
      <!--<![endif]-->
          <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fff;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
            <div role="banner">
              ...
              <!--[if (mso)|(IE)]><table align="center" class="header" cellpadding="0" cellspacing="0" role="presentation"><tr><td style="width: 600px"><![endif]-->
                <div class="logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;Margin-top: 6px;Margin-bottom: 20px;color: #c3ced9;font-family: Roboto,Tahoma,sans-serif;Margin-left: 20px;Margin-right: 20px;" align="center">
                  <div class="logo-center" align="center" id="emb-email-header"><img style="display: block;height: auto;width: 100%;border: 0;max-width: 48px;" src="https://thebob.com.br/pixels/images/mail-icon.png" alt="" width="48" /></div>
                </div>
              <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
              </div>
            </div>
            ...
            <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
              <p class="size-15" style="Margin-top: 0;Margin-bottom: 0;font-family: roboto condensed,arial narrow,avenir next condensed,roboto,sans-serif;font-size: 15px;line-height: 23px;text-align: center;" lang="x-size-15"><span class="font-roboto"><span style="color:#000000"><strong>Pixel Creatures</strong></span></span></p>
            </div>
          </div>
            ...
            <div style="background-color: #1c4a73;background-position: 0px 0px;background-image: url(https://thebob.com.br/pixels/images/background_mail.jpg);background-repeat: no-repeat;">
            ...
            <div style="mso-line-height-rule: exactly;line-height: 36px;font-size: 1px;">&nbsp;</div>
                    ...
                    <div style="Margin-left: 20px;Margin-right: 20px;">
            <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
              <p class="size-15" style="Margin-top: 0;Margin-bottom: 20px;font-family: roboto condensed,arial narrow,avenir next condensed,roboto,sans-serif;font-size: 15px;line-height: 23px;text-align: center;" lang="x-size-15"><span class="font-roboto"><span style="color:#fff">'.$line1.'</span></span></p>
            </div>
          </div>
                  
                    <div style="Margin-left: 20px;Margin-right: 20px;">
            <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
              <p class="size-18" style="Margin-top: 0;Margin-bottom: 20px;font-family: roboto condensed,arial narrow,avenir next condensed,roboto,sans-serif;font-size: 17px;line-height: 26px;text-align: center;" lang="x-size-18"><span class="font-roboto"><span style="color:#fff">'.$line2.'</span></span></p>
            </div>
          </div>
                  
                    <div style="Margin-left: 20px;Margin-right: 20px;">
            <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
              <p class="size-15" style="Margin-top: 0;Margin-bottom: 20px;font-family: roboto condensed,arial narrow,avenir next condensed,roboto,sans-serif;font-size: 15px;line-height: 23px;text-align: center;" lang="x-size-15"><span class="font-roboto"><span style="color:#fff">'.$line3.'</span></span></p>
            </div>
          </div>
                  
                    <div style="Margin-left: 20px;Margin-right: 20px;">
            <div class="btn btn--flat btn--large" style="Margin-bottom: 20px;text-align: center;">
              <![if !mso]><a style="border-radius: 0;display: inline-block;font-size: 14px;font-weight: bold;line-height: 24px;padding: 12px 24px;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #ffffff !important;background-color: #0e4cc9;font-family: Roboto Condensed, Arial Narrow, Avenir Next Condensed, Roboto, sans-serif;" href="'.$buttonLink.'">'.$buttonText.'</a><![endif]>
            <!--[if mso]><p style="line-height:0;margin:0;">&nbsp;</p><v:rect xmlns:v="urn:schemas-microsoft-com:vml" href="https://thebob.com.br/pixels/view.php" style="width:145px" fillcolor="#0E4CC9" stroke="f"><v:textbox style="mso-fit-shape-to-text:t" inset="0px,12px,0px,12px"><center style="font-size:14px;line-height:24px;color:#FFFFFF;font-family:Roboto Condensed,Arial Narrow,Avenir Next Condensed,Roboto,sans-serif;font-weight:bold;mso-line-height-rule:exactly;mso-text-raise:4px">Click here to see!</center></v:textbox></v:rect><![endif]--></div>
          </div>
                  ...
                  <div class="column wide" style="text-align: left;font-size: 12px;line-height: 19px;color: #adb3b9;font-family: sans-serif;Float: left;max-width: 400px;min-width: 320px; width: 320px;width: calc(8000% - 47600px);">
                    <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                      ...
                      <div style="font-size: 12px;line-height: 19px;">
                        <div>Pixel Creatures by DanielMGC</div>
                      </div>
